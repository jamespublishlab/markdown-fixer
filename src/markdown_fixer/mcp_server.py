...
class MarkdownFixerMCPServer:
    ...
    def __init__(self):
        ...
        # "explicit": the MCP tools are a direct request to reformat, like the
        # CLI -- not an automatic interception like the PreToolUse hook.
        self.fixer = MarkdownFixer(fix_options(load_config(), "explicit"))
    ...
    def _fix_markdown(self, request_id: Any, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "jsonrpc": "2.0",
                "id": request_id,
                "result": {"content": [{"type": "text", "text": fixed_content}], "isError": False},
            }
        except Exception as e:
